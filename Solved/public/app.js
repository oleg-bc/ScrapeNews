...
$.getJSON("/articles", function (data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    $("#articles").append("<p data-id='" + data[i]._id + "'>" + data[i].title + "<br />" + data[i].link + "</p>"+"saved: "+data[i].saved);
...
$(document).on("click", "#savedview", function () { 
  ...
  //  console.log(data);
   for (var e = 0; e < data.length; e++) {
     ...
     $("#articles").append("<button type='button'>ADD NOTES button</button>");
     $("#articles").append("<button type='button'>UN--SAVE button</button>");
   }
 });
});
